      ...
      <div>
        <Paper style={style} zDepth={1}>
          <Gradient style={{ height: '65px' }}>
              ...
              <img src={E} alt="Eventmakr logo" onClick={this.goHome} style={{ marginLeft: '40%', marginTop: '1%' }} />
              <img src={Search} alt="list icon" onClick={this.toggleSearch} style={{ height: '20px', marginTop: '-9%', marginLeft: '92%' }} />
            </Gradient>
        </Paper>
