...
function About(props) {
  return (
    <div id="about" >
      ...
      <div style={{ display: 'block', width: '100%', margin: '0 auto', paddingTop: '1%', marginTop: '4%' }}>
        <div style={{ display: 'block', width: '100%', margin: '0 auto', marginLeft: '47%' }}>
          <div style={{ display: 'inline-flex' }}>
            ...
            <a href="https://www.instagram.com/eventmakrr/" target="blank"><img src={Instagram} style={{ width: '50px', height: '50px', padding: '.25em' }} /></a>
          </div>
        </div>
