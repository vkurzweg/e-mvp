...
function TextWeb(props) {
  ...
  return (
    <div style={{ display, marginTop: '3%' }}>
      <div style={{ fontSize: '18px', padding: '.5em', paddingTop: '1%', paddingBottom: '1%', textAlign: 'center', color: '#FAFAFA', width: '85%', display: 'block', margin: '0 auto', backgroundColor: 'rgba(0,0,0,0.6)', borderRadius: '5px' }}>
