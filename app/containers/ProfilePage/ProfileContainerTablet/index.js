...
export class ProfileContainer extends React.Component { // eslint-disable-line react/prefer-stateless-function
  render() {
    return (
      <div style={{ backgroundColor: '#E2E2E2', height: '100%', paddingBottom: '30%', paddingTop: '5%' }}>
        <Paper zDepth={2} style={{ display: 'block', margin: '0 auto', marginTop: '5%', padding: '5%', backgroundColor: '#FAFAFA', width: '80%', marginBottom: '20%' }}>
          <UserInfo
