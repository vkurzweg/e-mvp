    ...
    return (
      <div>
          ...
          <FlexContainer>
            <div style={{ display }}>
              ...
              <div style={{ display: disableBtn }}>
                <Button className="btn btn-success" onClick={this.props.loginAttempt}>LOGIN123</Button>
              </div>
        ...
        <div style={{ display: displayMessage }}>
          <p style={{ textAlign: 'center', marginTop: '15%' }}>Hello {this.props.currentVendor.toJS().name}! You are logged in.</p>
        </div>
      </div>
    );
  }
